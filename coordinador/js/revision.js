...
function eje1(){
  ...
  cont += "          <label for=\"1.4.a.1\" class=\"respuesta\">Constantemente se renuevan carreras y planes de estudios. Así como problemáticas de la comunidad, profesores y alumnos.</label>";
...
function eje2(){
  ...
  cont += "          <label for=\"2.4.a.1\" class=\"respuesta\">Sí, hay un presupuesto asignado para la operación del programa de tutorías. Es suficiente para operar el programa ya que, permite realizar actividades para beneficio de los involucrados.</label>";
