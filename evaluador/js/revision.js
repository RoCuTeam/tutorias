...
function eje1(){
  ...
  cont += "          <label for=\"1.1.a.1\" class=\"respuesta\">La Universidad Tecnológica de Jalisco se encuentra en la calle Luis J. Jiménez #577, Col. 1o. de Mayo, en el municipio de Guadalajara que se encuentra dentro de la zona geográfica 'A' </label>";
  ...
  cont += "          <label for=\"1.1.a.3\" class=\"respuesta\">21 Años</label>";
  ...
  cont += "          <textarea class=\"comentarioResp\" name=\"comentario\" id=\"1.1.a.3\" placeholder=\"Escribe una respuesta...\"></textarea>";
  ...
  cont += "          <label for=\"1.1.a.4\" class=\"respuesta\">Formar capital humano emprendedor con sólida preparación a través de programas educativos de calidad desde su concepción y estructura psicopedagógica, hasta la obtención de una pertinencia social, académica y laboral. </label>";
  ...
  cont += "          <label for=\"1.1.a.5\" class=\"respuesta\">Institución reconocida, que atiende los requerimientos del sector productivo de bienes y de servicios caracterizados por su calidad, pertinencia y relevancia. </label>";
  ...
  cont += "          <label for=\"1.1.a.5\" class=\"etiquetaResp\">Escriba una respuesta </label>";
  cont += "          <textarea class=\"comentarioResp\" name=\"comentario\" id=\"1.1.a.5\" placeholder=\"Escribe una respuesta...\"></textarea>";
  ...
  cont += "          <label for=\"1.1.a.6\" class=\"respuesta\">I.  Servicio: Brindar ayuda de manera espontánea, en los detalles más pequeños. <br> II. Compromiso: Poner en juego nuestra capacidades para sacar adelante todo aquello que se nos ha confiado. <br>III.  Integridad: Cualidad de ser la misma persona como un todo, con un comportamiento intachable tanto en lo privado como en lo público y en circunstancias diferentes. <br> IV. Trabajo en equipo: Capacidad de coordinar, respetar y aprovechar conocimientos, habilidades y experiencias de los integrantes del equipo para alcanzar resultados. </label>";
  ...
  cont += "          <label for=\"1.2.a.1\" class=\"respuesta\">Programa Institucional de Tutorías</label>";
  ...
  cont += "          <label for=\"1.2.a.2\" class=\"respuesta\">Porque es un nombre adecuado y formal con el fin de englobar todos los procesos de Tutorías.</label>";
  ...
  cont += "          <textarea class=\"comentarioResp\" name=\"comentario\" id=\"1.2.a.2\" placeholder=\"Escriba una respuesta...\"></textarea>";
  ...
  cont += "          <label for=\"1.3.a.1\" class=\"respuesta\">5000 Alumnos</label>";
  ...
  cont += "          <label for=\"1.3.a.2\" class=\"respuesta\">2000 Tutores</label>";
  ...
  cont += "          <label for=\"1.3.a.5\" class=\"respuesta\">Es suficiente porque se cubre el 95% de alumnos, ya que hay algunos alumnos que no asisten a sus sesiones de tutoría, para este problema ya se está realizando una solución.</label>";
  cont += "          <label for=\"1.3.a.5\" class=\"etiquetaComent\">Comentarios: </label>";
  cont += "          <label for=\"1.3.a.5\" class=\"comentarioEjem\">Explicar específicamente la solución del problema de inasistencia de alumnos a sus sesiones de Tutorías.</label>";
  ...
  cont += "          <textarea class=\"comentarioResp\" name=\"comentario\" id=\"1.3.a.5\" placeholder=\"Escribe una respuesta...\"></textarea>";
  cont += "          <label for=\"1.3.a.5\" class=\"comentarioEjem\">Realizar encuestas a alumnos sobre la solución del problema de inasistencia.</label>";
  ...
  cont += "          <label for=\"1.4.a.1\" class=\"respuesta\">Constantemente se renuevan carreras y plan de estudios. Así como problemáticas de la comunidad, profesores y alumnos.</label>";
...
function eje2(){
  ...
  cont += "          <label for=\"2.1.a.1\" class=\"respuesta\">Opera desde la Universidad Tecnológica de Jalisco.</label>";
  ...
  cont += "          <label for=\"2.1.a.2\" class=\"respuesta\">En el puesto de responsable del Programa Institucional de Tutoría de la Universidad Tecnológica de Jalisco.</label>";
  ...
  cont += "          <label for=\"2.1.a.3\" class=\"respuesta\">1. Consejo Universitario: Verificar que los tutores y tutorados cumplan con sus labores correspondientes y corregir cualquier problema disciplinal o que incumpla con lo establecido. <br>2. Consejo directivo: Crea y actualiza nuevos métodos para la ejecución del Programa de Tutorías. <br>3. Dirección general: Resuelve conflictos menores correspondientes a tutores o tutarados. <br>4. Rectoría: Aprueba y supervisa el trabajo del organigrama inferior, para garantizar que las responsabilidades son ejecutadas satisfactoriamente. <br>5. Secretaría Académica: Supervisa el trabajo de Tutores con respecto a las necesidades de los Tutorados. Les brinda a los alumnos el medio para comunicar sus inquietudes y problemas.  </label>";
  ...
  cont += "          <label for=\"2.2.a.1\" class=\"respuesta\">Los marcos de referencia que dan sustento al PIT son: <br> Modelo educativo <br> Modelo académico <br> Plan de desarrollo <br> Reglamentos.</label>";
  cont += "          <textarea class=\"comentario\" name=\"comentario\" id=\"2.1.a.1\" placeholder=\"Agregar Comentario...\"></textarea>";
  cont += "";
  cont += "          <h5 >B) Documentos</h5>";
  cont += "          <div class=\"botones-documento\">";
  ...
  cont += "          <label for=\"2.4.a.1\" class=\"respuesta\">Si hay un presupuesto asignado para la operación del programa de tutorías. Es suficente para operar el programa ya que, permite realizar actividades para beneficio de los involucrados.</label>";
